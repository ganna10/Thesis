...
Methane has a lifetime of about $9$~years, significantly longer than other VOCs \citep{Seinfeld:2006}.
...
Although isoprene is considered as a biogenic VOC (BVOC), it has been measured in the urban areas of London and Paris away from biogenic emission sources and during times where biogenic emissions are not important, such as freeing conditions in winter.
...
For example, EDGAR \citep{Olivier:2001} specifies global emissions while TNO-MACCIII \citep{Kuenen:2014} specifies European emissions.
\begin{table}[t]%
    \centering%
