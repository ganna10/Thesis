...
\subsection{Air Quality Standards}
...
This relationship can be divided into distinct regimes: \emph{\ce{NO_x}-sensitive}, \emph{VOC-sensitive} and 
\emph{VOC-and-\ce{NO_x}-sensitive}. The \ce{NO_x}-sensitive regime is the right-most part, the VOC-and-\ce{NO_x}-senstive 
...
Compounds that have many mechanistic uncertainties or when the mechanism of the compound has little difference with that of 
...
%conclusion part  - talk about how the project shall proceed
...
TOPP values shall be calculated over a range of \ce{NO_x} concentrations, thus invoking the different regimes of the atmosphere 
...
The model runs are then allowed to elapse for seven diurnal cycles under equinoctical conditions with the photolysis rates of 
the applicable latitude.  The \ce{NO_x} level at each time-step is calculated on-line by setting the NO emission level to be 
equal to the source of radicals minus the chemical source of \ce{NO_x}. This ensures that the calculations are not influenced by
excessive \ce{NO_x} levels and also so that \ce{O3} production via NMVOC oxidation is maximised.

The next part of the study shall determine the TOPP values for the NMVOCs used over a range of \ce{NO_x} concentrations. This 
