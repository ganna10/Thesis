...
\begin{itemize}
	\item How do the simplification techniques used in different chemical mechanisms affect ozone production? Does the choice of chemical mechanism impact predicted ozone production?
\end{itemize}
...
\begin{itemize}
    \item Are temperature dependent emissions or temperature dependent chemical processes more important for ozone production with increasing temperature? How is temperature dependent ozone production treated in different \ce{NO_x} regimes within a box model?
\end{itemize}
