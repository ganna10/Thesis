...
The chemistry of ozone production depends on the concentrations of VOCs and \ce{NO_x} in the troposphere (Sect.~\ref{ss:VOC_NOx}).
In this section, the sources and sinks of the precursors to ozone production are discussed.

% NOx sources and quantities, weekend effect
\subsection[NOx]{\ce{NO_x}}
Anthropogenic activities are the main sourece of \ce{NO_x} emissions into the atmosphere.
...
%
%The NMVOC species emitted vary between types of vegetation -- some trees emit large amounts of isoprene while others do not emit isoprene at all.
...
%As a consequence of the non-linear relationship of ozone production with VOC and \ce{NO_x}, areas dominated by biogenic NMVOC emissions and away from large \ce{NO_x} sources (\ce{NO_x}-sensitive regime) could lead to net loss of ozone through direct reactions of ozone with many biogenic NMVOC and the net loss of radicals (Sect.~\ref{ss:VOC_NOx}).
