...
\begin{figure}[t]
    \begin{center}
        ...
        %\includegraphics[width = \textwidth]{CH4_degradation}
...
During the night-time, reaction with the nitrate (\ce{NO3}) radical is of importance.
...
The competition between these reactions, especially those pathways involving \ce{NO_x} (\eqref{r:RO2_NOa}, \eqref{r:RO2_NOb} and \eqref{r:RO2_NO2}), determines whether net production or loss of ozone occurs. 
\begin{rxnarray}
...
Hence, at lower temperatures \ce{RO2NO2} may build up and be transported away from their region of formation and re-release \ce{RO2} and \ce{NO2} downwind fuelling ozone production away from large sources of \ce{NO_x}.
