...
Detailed process studies are key to understanding the differences between simulated ozone levels using different models.
...
Tropospheric ozone is formed via photochemical production from the reactions between VOCs and \ce{NO_x}, described in Sect.~\ref{s:ozone_chemistry}, while meteorology and transport also influence ozone concentrations.
...
Modelling of ozone production has helped understand the complexity of atmospheric chemistry, such as the non-linear relationship of ozone production with precursor (VOC and \ce{NO_x}) emissions.
...
\begin{figure}[t]%
    \begin{center}%
        ...
        \vspace{3mm}
        \includegraphics[scale = 0.5]{CH4_degradation}%
...
The initial oxidation of NMVOCs produces \ce{RO2} radicals and the fate of the \ce{RO2} determines whether net loss or production of ozone occurs.
\vspace{7mm}
\begin{rxnarray}
...
Figure~\ref{f:O3_isopleth}, taken from \citet{Jenkin:2000}, depicts the non-linear relationship between ozone as a function of VOC and \ce{NO_x}.
...
In regions with low-\ce{NO_x} concentrations, \ce{RO2} are more likely to react with other radicals rather than convert NO to \ce{NO2}.
...
Higher levels of VOC increase the likelihood of \ce{RO2} converting NO to \ce{NO2} leading to ozone production while higher \ce{NO_x} levels will not increase \ce{O3} production.  
...
\citet{Pusede:2015} also highlighted a lack of modelling studies considering the relationship between ozone production and temperature with different \ce{NO_x} conditions.

The final part of this work simulates this relationship between ozone, temperature and \ce{NO_x} and determines whether temperature-dependent BVOC emissions or temperature-dependent chemistry is more important for ozone production in urban areas.
