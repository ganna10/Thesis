...
Thus, many VOC in reduced chemical mechanisms produce a lower maximum of \ce{O_x} than the MCM~v3.2 leading to lower \ce{O3} mixing ratios from the reduced chemical mechanisms compared to the MCM~v3.2.
...
Analysis of \ce{O_x} production and consumption budgets showed that the net increase in \ce{O_x} production with temperature was due to the faster reaction rates of initial oxidation of VOCs.
